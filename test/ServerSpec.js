...
describe('', function () {
  ...
  beforeEach(function () {
    ...
    // delete user 123456789012345678901 from db so it can be created later for the test
    db.knex('users')
      .where('username', '=', '123456789012345678901')
      .del()
      .catch(function (error) {
        // uncomment when writing authentication tests
        // throw {
  ...
  describe('Account Creation:', function () {
    ...
    //NEW TEST-----------------------------------------
    it('Should not sign up duplicate user', function (done) {
      var options = {
        'method': 'POST',
        'uri': 'http://127.0.0.1:4568/signup',
        'json': {
